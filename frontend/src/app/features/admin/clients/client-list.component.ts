          ...
          <table class="w-full">
            <thead>
              <tr class="bg-zinc-50 border-b border-zinc-200">
                ...
                <th class="text-left px-5 py-3 micro-label hidden md:table-cell">Documento</th>
                <th class="text-left px-5 py-3 micro-label hidden lg:table-cell">Ciudad</th>
                <th class="text-center px-5 py-3 micro-label">Pedidos</th>
                <th class="text-right px-5 py-3 micro-label hidden sm:table-cell">Total Gastado</th>
                <th class="text-left px-5 py-3 micro-label hidden lg:table-cell">Última Compra</th>
                ...
                >
                  <td class="px-5 py-4">
                    <div class="flex items-center gap-3">
                      ...
                      <div>
                        <p class="text-sm font-bold text-zinc-900">{{ client.nombre }}</p>
