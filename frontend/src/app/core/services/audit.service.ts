...
function generateMockLogs(): AuditLog[] {
  ...
  const entries: { usuario: string; id: number; rol: UserRole; accion: AuditAction; entidad: AuditEntity; ref?: string; detalle: string; hoursAgo: number }[] = [
    ...
    { usuario: 'Pedro López', id: 3, rol: 'logistica', accion: 'marcar_en_camino', entidad: 'pedido', ref: 'GEP-2024006', detalle: 'Pedido despachado — Ruta Armenia - Calarcá', hoursAgo: 1.5 },
    ...
    { usuario: 'Pedro López', id: 3, rol: 'logistica', accion: 'marcar_en_camino', entidad: 'pedido', ref: 'GEP-2024007', detalle: 'Pedido despachado — Ruta Circasia - Filandia', hoursAgo: 3.5 },
    ...
    { usuario: 'Admin', id: 1, rol: 'admin', accion: 'ver_cliente', entidad: 'cliente', ref: 'Cafeteros & Agro del Quindío', detalle: 'Consultó perfil del cliente', hoursAgo: 4.5 },
    ...
    { usuario: 'Diego Ramírez', id: 5, rol: 'logistica', accion: 'marcar_entregado', entidad: 'pedido', ref: 'GEP-2024004', detalle: 'Entrega confirmada — Vía Panaca, Quimbaya', hoursAgo: 6.0 },
    ...
    { usuario: 'Pedro López', id: 3, rol: 'logistica', accion: 'marcar_entregado', entidad: 'pedido', ref: 'GEP-2024009', detalle: 'Entrega confirmada — Salento Centro', hoursAgo: 7.5 },
